...
the [Encode-TestDesign-Kata](https://github.com/emilybache/Encode-TestDesign-Kata)
by [Emily Bache](https://github.com/emilybache). Thank you for the original project and for
