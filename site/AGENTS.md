...
Regenerate docs with the `/nw-document` pipeline rather than hand-editing where a matching artifact exists; its research + validation reports live under the repo-root `docs/` (not here — `docs/` is kept out of Jekyll's build).
